...
% end
    ...
    <head>
        <meta charset="utf-8">
        <title>CanIRun!</title>
        <link href="./static/clock_speed_fail_style.css" type="text/css" rel="stylesheet">
        <style>
            @font-face {
    ...
    <body>
        ...
        <h2>
            ...
            You cannot run this game because your chip has a <span>clock speed of {{user_clock_speed}}</span>,
            while <span class="game">{{game}}</span> calls for a clock speed of at least <span>{{game_clock_speed}}</span>.
        </h2>
    </body>
</html>
