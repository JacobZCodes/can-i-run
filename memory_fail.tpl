...
<html>
    <head>
        <meta charset="utf-8">
        <title>CanIRun!</title>
        <link href="/static/C:/Users/Jacob/Desktop/CanIRun_FrontEnd/memory_fail_style.css" type="text/css" rel="stylesheet">
    </head>
    <body>
        <h1>MEMORY - FAIL!</h1>
        <h2><p>Your computer has something called RAM, or Random Access Memory. Every time you touch a key, move your mouse, or open a 
            ...
            <p>On the other hand, your computer also has volatile memory; this means that it does require electricity in order to exist. When your computer is powered off,
            ...
            these are all related to your RAM.</p>

            <p>Since your RAM is directly related to how quickly your game reacts to your system's input, it is obviously one of the most important factors. You only have
            <span>{{specs_result_dict['Fail']['Memory']['User']}} GB RAM</span>, while <span class="game">{{game}}</span> requires <span>{{specs_result_dict['Fail']['Memory']['Game']}}</span>.</p>
        </h2>
    </body>
</html>