...
<html>
    <head>
        <meta charset="utf-8">
        <title>CanIRun!</title>
        <link href="/static/C:/Users/Jacob/Desktop/CanIRun_FrontEnd/directx_success_style.css" type="text/css" rel="stylesheet">
        <style>
            @font-face {
    ...
    <body>
        ...
        <h2>
            ...
            <p>Coming back to DirectX, you are currently running version <span>{{specs_result_dict['Success']['DirectX']['User']}}</span> of DirectX and <span class="game">{{game}} requires {{specs_result_dict['Success']['DirectX']['Game']}}</span>. DirectX is constantly
