...
<html>
    ...
    <body>
        ...
        <h2>
            <p>It might not come as a huge surprise to find out that your computer does not have infinite storage space. But what exactly does storage space look like in 
            a digital context?
            ...
            </p><p>This is why hard drives are considered to be non-volatile; they don't require electricity to store the data written onto them. This is why when your
            ...
            is equivalent to 1000 MB.</p>

            <p>You have <span>{{specs_result_dict['Success']['Storage']['User']}} GB of space available</span> and <span class="game">{{game}}</span> calls for <span>{{specs_result_dict['Success']['Storage']['Game']}}.</span></p>
        </h2>
    </body>
</html>